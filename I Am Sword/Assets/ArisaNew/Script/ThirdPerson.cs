...
public class ThirdPerson : MonoBehaviour 
{
	...
	void Update()
	{
		...
		angleH += Mathf.Clamp(Input.GetAxis("Mouse X"), -1, 1) * horizontalAimingSpeed; // 카메라 움직이는거
		angleV += Mathf.Clamp(Input.GetAxis("Mouse Y"), -1, 1) * verticalAimingSpeed; //카메라 움직이는건
